# Installing kube-prometheus-stack on Example's OpenShift 4
...
3. [App Registration in AAD for Grafana](#app-registration-in-aad-for-grafana)
4. [Configuration of Application Roles for Grafana in AzureAD](#configuration-of-application-roles-for-grafana-in-azuread)
5. [Helm Chart CLI](#helm-chart-cli)

## Introduction

This procedure deploys [kube-prometheus-stack](https://github.com/prometheus-community/helm-charts/tree/main/charts/kube-prometheus-stack) on Example's on-prem OpenShift 4. Each new deployment includes by default the latest version of Grafana (v10.4.1 in May 2024), and it is also possible to add the version in the installation parameters of the helm chart (**v11.0.0** in May 2024).
...
## App Registration in AAD for Grafana

The Grafana of kube-prometheus-stack has been configured with Example's AzureAD via OAuth2.0, for which it is necessary to [add a registered application in AzureAD for grafana](https://grafana.com/docs/grafana/latest/setup-grafana/configure-security/configure-authentication/azuread/):
...
## Configuration of Application Roles for Grafana in AzureAD
